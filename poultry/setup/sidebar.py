...
SIDEBARS = {
	...
	"Hatchery": {
		...
		"items": [
			...
			("Hatchery Board", "Page", "poultry-hatch-board", "poultry-hatchery"),
			("Hatching Egg Receipt", "DocType", "Hatching Egg Receipt", "poultry-egg-tray"),
			...
			("Breakout Analysis", "DocType", "Breakout Analysis", "poultry-search"),
			("Chick Type", "DocType", "Chick Type", "poultry-rearing"),
