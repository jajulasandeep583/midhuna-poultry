...
MAIN_LINKS = [
	...
	link("Cost & Profitability", "Page", "poultry-cost-hub",
	     description="Cost per bird and per kilogram, by flock"),
...
MAIN_SHORTCUTS = [
	...
	shortcut("Vaccination & Health", "poultry-health-hub", type_="Page", color="Green"),
	shortcut("Cost & Profitability", "poultry-cost-hub", type_="Page", color="Purple"),
